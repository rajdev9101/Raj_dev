...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002465960701').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002465960701')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002350777458')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'raj_dev21') # owner username without @
...
CHNL_LNK = environ.get('CHNL_LNK', '-https://t.me/rajdeb21')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'raj_dev21') # Support Chat Link Without https:// or @
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+H-l9E4CaQ8pmZDBl') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
